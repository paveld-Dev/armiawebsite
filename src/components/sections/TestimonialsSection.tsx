...
export function TestimonialsSection() {
  return (
    <section className="relative w-full bg-[#fcfcfc] text-[#111111] py-8 md:py-12 border-t border-black/[0.08] overflow-hidden select-none snap-section h-[100svh] min-h-[100svh] flex flex-col justify-center">
      <GridLines light />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center px-6 md:px-12 lg:px-16">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between h-full pr-0 lg:pr-8">
            <div>
              ...
              >
                <span className="block text-[#999999] font-light">TRUSTED BY</span>
                <span className="block text-[#111111]">ENGINEERING</span>
                <span className="block text-[#111111] font-medium">LEADERS.</span>
              </motion.h2>
          ...
          <div className="lg:col-span-7">
            ...
            >
              {testimonialsData.map((item, index) => (
                ...
                >
                  {index < 2 && (
                    <div className="absolute top-0 left-0 right-0 h-[2.5px] bg-brand-accent origin-left scale-x-[0.92] transition-transform duration-500 group-hover:scale-x-100" />
                  )}

                  <div>
                    <div className="flex items-start justify-between mb-3">
                      <div className="relative h-11 w-11 overflow-hidden rounded-xs bg-neutral-100 border border-black/[0.08] shrink-0">
